package aungpyaephyo.net.phandeeyarlivecoding.utils;
...
import aungpyaephyo.net.phandeeyarlivecoding.PhandeeyarLiveCodingApp;
...
public class JsonUtils {
    ...
    private JsonUtils() {
        context = PhandeeyarLiveCodingApp.getContext();
    }
